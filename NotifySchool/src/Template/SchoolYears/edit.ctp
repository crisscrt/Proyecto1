...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $schoolYear->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $schoolYear->id)]
            )
        ?></li>
...
<div class="schoolYears form large-9 medium-8 columns content">
    <?= $this->Form->create($schoolYear) ?>
    <fieldset>
        <legend><?= __('Edit School Year') ?></legend>
        <?php
